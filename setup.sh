...
setup gitconfig-da                    "$HOME/.gitconfig-da"
...
setup nixpkgs.nix                     "$HOME/.config/nixpkgs/config.nix"
...
setup alacritty.toml                  "$HOME/.config/alacritty/alacritty.toml"
setup alacritty-themes/seashells.toml "$HOME/.config/alacritty/current_theme.toml"
